...
class Basket {
  ...
  constructor(className: string) {
    ...
    if (!document.querySelector(className))
      throw new Error("there is no basket");
    this.container = document.querySelector(className) as HTMLElement;

    if (!this.container.querySelector(".basket__count"))
      throw new Error("there is no .basket__count");
    this.count = this.container.querySelector(".basket__count") as HTMLElement;

    if (!this.container.querySelector(".basket__total_price"))
      throw new Error("there is no .basket__count");
